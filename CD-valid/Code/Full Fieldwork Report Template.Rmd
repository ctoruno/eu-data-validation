...
time<- suppressMessages(suppressWarnings(left_join(df$time_changes, pre_time)))%>% distinct()
...
flagsoutputsub$Label<- ifelse(flagsoutputsub$red >= flagsoutputsub$sum/2, "Significantly Different", ifelse(flagsoutputsub$red+flagsoutputsub$yellow >= 3*flagsoutputsub$sum/4, "Significantly Different", ifelse(flagsoutputsub$yellow >= 3*flagsoutputsub$sum/4, "Significantly Different", "Not Significantly Different")))

flagsoutputsub<- flagsoutputsub%>%
  select(Sub_Pillar, green, yellow, red, perc, Label)

colnames(flagsoutputsub)<- c("Sub-Pillar", "Green Flags", "Yellow Flags", "Red Flags", "Percentage Red Flags", "Label")
...
flagsoutput2sub$Label<- ifelse(flagsoutput2sub$red >= flagsoutput2sub$sum/2, "Significantly Different", ifelse(flagsoutput2sub$red+flagsoutput2sub$yellow >= 3*flagsoutput2sub$sum/4, "Significantly Different", ifelse(flagsoutput2sub$yellow >= 3*flagsoutput2sub$sum/4, "Significantly Different", "Not Significantly Different")))

flagsoutput2sub<- flagsoutput2sub%>%
  select(Sub_Pillar, green, yellow, red, perc, Label)

colnames(flagsoutput2sub)<- c("Sub-Pillar", "Green Flags", "Yellow Flags", "Red Flags", "Percentage Red Flags", "Label")
...
warningssuboutput$Label<- ifelse(warningssuboutput$`Red light` >= warningssuboutput$sum/2, "Significantly Different", ifelse(warningssuboutput$`Red light`+warningssuboutput$`Yellow light` >= 3*warningssuboutput$sum/4, "Significantly Different", ifelse(warningssuboutput$`Yellow light` >= 3*warningssuboutput$sum/4, "Significantly Different", "Not Significantly Different")))

warningssuboutput<- warningssuboutput%>%
  select(subpillar, `Green light`, `Yellow light`, `Red light`, perc, Label)

colnames(warningssuboutput)<- c("Sub-Pillar", "Green Flags", "Yellow Flags", "Red Flags", "Percentage Red Flags", "Label")
...
knitr::kable(warningssuboutput, escape = F)%>%
  kable_classic(html_font = "Arial")%>%
  kable_styling(bootstrap_options = c("striped"))%>%
  column_spec(6, background = ifelse(warningssuboutput$Label == "Significantly Different", "#FC7661" , "#B6F161"))%>%
  column_spec(5, bold = TRUE)%>%
...
knitr::kable(flagsoutputsub, escape = F)%>%
  kable_classic(html_font = "Arial")%>%
  kable_styling(bootstrap_options = c("striped"))%>%
  column_spec(6, background = ifelse(flagsoutputsub$Label == "Significantly Different", "#FC7661" , "#B6F161"))%>%
  column_spec(5, bold = TRUE)%>%
  scroll_box(height = "500px", fixed_thead = T)
...
knitr::kable(flagsoutput2sub, escape = F)%>%
  kable_classic(html_font = "Arial")%>%
  kable_styling(bootstrap_options = c("striped"))%>%
  column_spec(6, background = ifelse(flagsoutput2sub$Label == "Significantly Different", "#FC7661" , "#B6F161"))%>%
  column_spec(5, bold = TRUE)%>%
  scroll_box(height = "500px", fixed_thead = T)
