...
**The previous GPP data from Greece is from 2017 (over 6 years old). Therefore, significant changes are expected.**
...
appendixtps <- merge(threshold1, cb2, by.x="GPP_Variable_Name", by.y =  "Variable", all.x = TRUE)
