...
knitr::kable(b2, caption = "Variable List and Flags", booktabs = F, escape = F, digits=3)%>%
  kable_classic(html_font = "Arial", )%>%
  kable_styling(bootstrap_options = c("striped"), full_width = T)%>%
  row_spec(which(b2$Flag == "Red"), background = "#F88888")%>%
  row_spec(which(b2$Flag == "Green"), background = "#CAF888")%>%
  row_spec(which(b2$Flag == "Yellow"), background = "#F8F688")%>%
...
knitr::kable(b2, caption = "Variable List and Flags", booktabs = T, escape = F)%>%
  kable_classic(html_font = "Arial")%>%
  kable_styling(bootstrap_options = c("striped"), full_width = T)
```
...
knitr::kable(a2, caption = "Variable List and Flags", booktabs = T, escape = F)%>%
  kable_classic(html_font = "Arial", )%>%
  kable_styling(bootstrap_options = c("striped"), full_width = T, font_size = 12)
...
knitr::kable(e2, caption = "Variable List and Flags", booktabs = T, escape = F)%>%
  kable_classic(html_font = "Arial", )%>%
  kable_styling(bootstrap_options = c("striped"), full_width = T, font_size = 12)
