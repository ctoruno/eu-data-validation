...
if (clevel[[1]] == 1 & clevel[[2]] == 1){
  ...
  probl<- "statistically different from both the previous GPP and the Third Party Sources"
  ...
  probl<- "statistically different from only the Third Party Sources"
  ...
  probl<- "statistically different from only the previous GPP"
  rec<- "we recommend that the EU GPP team should decide whether to present any concern to the survey company."
  
} else if (clevel[[1]] == 0 & clevel[[2]] == 0){
  probl<- "not statistically different from the previous GPP or the Third Party Sources"
...
## Pillar and Sub-Pillar Details {.tabset}
