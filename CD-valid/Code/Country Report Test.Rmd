...
for (p in unique(threshold$Pillar)){
  ...
  if ("red" %in% unique(pillar$Flag)){
    ...
    } else if ( (pillar$n[pillar$Flag == "red"] + pillar$n[pillar$Flag == "yellow"])/sp > 0.5){
...
flagsoutput2$Label<- ifelse(flagsoutput2$red> flagsoutput2$sum/4, "Significantly Different", ifelse(flagsoutput2$red+flagsoutput2$yellow > flagsoutput2$sum/2, "Significantly Different", ifelse(flagsoutput2$yellow > flagsoutput2$sum/2, "Significantly Different", "Not Significantly Different")))
