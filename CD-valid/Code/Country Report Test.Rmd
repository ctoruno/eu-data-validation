...
flagsoutput<- flagsoutput%>%
  ...
  mutate(perc = paste0(round(green/sum*100, digits = 1), "%"))
...
colnames(flagsoutput)<- c("Pillar", "Green Flags", "Yellow Flags", "Red Flags", "Percentage Green Flags", "Label")
...
colnames(flagsoutput2)<- c("Pillar", "Green Flags", "Yellow Flags", "Red Flags", "Percentage Green Flags", "Label")
...
warningsoutput<- warningsoutput%>%
  ...
  mutate(perc = paste0(round(`Green light`/sum*100, digits = 1), "%"))
